...
**Note:** Version bump only for package @puggo-org/bootstrap
...
* Move @puggo-org/has-dependency-installed into bootstrap/lib ([c09ccbd](https://github.com/lerna/lerna/commit/c09ccbd))
